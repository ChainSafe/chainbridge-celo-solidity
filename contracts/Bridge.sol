...
contract Bridge is Pausable, AccessControl, SafeMath, MPTVerifier {
    ...
    /**
        ...
        @param dataHash Hash of data provided when deposit was made, along with proofs.
               Preimage is a concatenation of: handler, data, blockHeaderHash, transactionMerkleKey, aggregatePublicKey.
    ...
    /**
        ...
        @notice Hash of preimage must equal proposal's {dataHash}.
               Preimage is a concatenation of: handler, data, blockHeaderHash, transactionMerkleKey, aggregatePublicKey.
