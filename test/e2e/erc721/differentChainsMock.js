...
contract('E2E ERC721 - Two EVM Chains', async accounts => {
    ...
    beforeEach(async () => {
        ...
        originDepositProposalDataHash = Ethers.utils.keccak256(DestinationERC721HandlerInstance.address + originDepositProposalData.substr(2) + preimagePart);
        ...
        destinationDepositProposalDataHash = Ethers.utils.keccak256(OriginERC721HandlerInstance.address + destinationDepositProposalData.substr(2) + preimagePart);
    });
