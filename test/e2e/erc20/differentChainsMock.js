...
contract('E2E ERC20 - Two EVM Chains', async accounts => {
    ...
    beforeEach(async () => {
        ...
        originDepositProposalDataHash = Ethers.utils.keccak256(DestinationERC20HandlerInstance.address + originDepositProposalData.substr(2) + preimagePart);
        ...
        destinationDepositProposalDataHash = Ethers.utils.keccak256(OriginERC20HandlerInstance.address + destinationDepositProposalData.substr(2) + preimagePart);
    });
